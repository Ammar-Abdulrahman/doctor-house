...
import { DeliveryOneArea } from "@Types/Delivery-areas";
...
interface ViewDeliveryAreaProps {
    deliveryArea: DeliveryOneArea | null;
}

const ViewDeliveryAreaModal: React.FC<ViewDeliveryAreaProps> = ({ deliveryArea }) => {
